...
<head>
    <title>Shopper an E-Commerce online Shopping Category Flat Bootstarp responsive Website Template| Home :: w3layouts
    </title>
    ...
    <div class="header">
        <div class="container">
            ...
            <div class="header-right">
                ...
                <div class="signin">
                    <div class="cart-sec">
                        <a href="cart.html"><img href="cart.html" src="{{ url('public') }}/images/cart.png"
                                alt="" />(0)</a>
                    </div>
                    <ul>
                ...
                <div id="horizontalTab">
                    ...
                    <div class="resp-tabs-container">
                        ...
                        <div>
                            ...
                            <link rel="stylesheet" href="{{ url('public') }}/css/flexslider.css" type="text/css"
                                media="screen" />
                            <script type="text/javascript">
